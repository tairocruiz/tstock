...
Route::get('/places-to-go/{area}', [DestinationCategoryController::class, 'show']);
        ...
        Route::get('/admin/tour-categories/create', [TourCategoryController::class, 'create']);//admin/tour-categories/add
        Route::post('/admin/tour-categories/store', ['as' => 'admin.tour-categories.store', 'uses' => 'App\Http\Controllers\TourCategoryController@store']);
...
//--
        ...
        Route::get('/admin/tours/add', [TourController::class, 'create']);
