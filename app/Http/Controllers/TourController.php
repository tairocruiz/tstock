...
class TourController extends Controller
{
    ...
    public function index()
    {
        ...
        $tours = Tour::all();
        return view('front.tours.index', compact('title', 'tours', 'tour_categories'));
    }
    ...
    public function start()
    {
        ...
        return view('admin.tours.all', compact('title', 'tours', 'pages', 'tour_categories', 'destination_categories'));
    }
    ...
    public function show($slug)
    {
        ...
        return view('front.tours.show', compact('tour','title', 'tours', 'pages', 'tour_categories', 'destination_categories'));
    }
...
//        return response($request->all());
    ...
    public function tailorMade()
    {
        ...
        $tour_categories = TourCategory::all();
        $destination_categories = DestinationCategory::all();
        $title = 'Tailor Made Safari Tours in Tanzania Africa';
        return view('front.tours.tailor-made', compact('destination_categories', 'tours', 'title', 'pages', 'tour_categories'));
    }
}
