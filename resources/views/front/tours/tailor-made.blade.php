    ...
    <div class="row header">
        ...
        @if($tours->count())
            <div class="col-md-12 p-0 header_img_container">
                <img src="images/tour_photos/{{ $tours->random()->photo }}" class="img-responsive" alt="Tailor Made Safaris">
            </div>
        @endif
    </div>
                ...
                @if(isset($tour))
                    <div class="panel panel-default mt-3">
                        ...
                        <div class="panel-body p-0">
                            <img src="images/tour_maps/{{ $tour->map }}" class="img-responsive" alt="{{ $tour->name }}">
                        </div>
