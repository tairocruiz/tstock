    ...
    @foreach($tour_categories as $tour_category)
        <div class="slide">
            ...
            <div class="slide-details">
                ...
                <p>
                    @if($tour_category->tours->count()) <span class="mr-3"><span class="badge">{{ $tour_category->tours->count() }}</span> Safari {{ Str::plural('Tour',$tour_category->tours->count()) }}</span> @endif
