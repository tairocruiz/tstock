    ...
    <nav class="tmt-navbar ubuntucondensed">
        <ul class="center text-uppercase">
            <li class="sub-menu">
                ...
                @if($pages->where('resource',0)->count())
                    <ul class="dropdown">
                        @foreach($pages->where('resource',0) as $page)
                            <li>
                                <a href="/{{ $page->slug }}">
                                    <i class="fa fa-angle-right mr-1"></i>{{ $page->name }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
            ...
            <li class="sub-menu">
                ...
                @if($tour_categories->count())
                    <ul class="dropdown">
                        @foreach($tour_categories->where('special',0)->sortByDesc(function ($category) { return $category->tours->count(); })->take(6) as $category)
                            <li>
                                <a href="/safaris/{{ $category->slug }}">
                                    <i class="fa fa-angle-right mr-1"></i>{{ $category->name }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
            ...
            <li class="sub-menu">
                ...
                @if($tour_categories->where('special',1)->count())
                    <ul class="dropdown">
                        ...
                        @endforeach
                            <li><a href="/safari-tours/tailor-made"><i class="fa fa-angle-right mr-1"></i>Tailor Made Safari</a></li>
                    </ul>
                @endif
            </li>
            <li class="sub-menu">
                <a href="#"><i class="fa fa-angle-right mr-2 visible-xs"></i>Resources</a>
                @if($pages->where('resource',1)->count())
                    <ul class="dropdown">
                        <li><a href="/tourism/blog"><i class="fa fa-angle-right mr-1"></i>Tourism Blog</a></li>
                        ...
                        @endforeach
                        <li><a href="/tour/gallery"><i class="fa fa-angle-right mr-1"></i>Photo Gallery</a></li>
                    </ul>
                @endif
            </li>
