...
@section('content')
    <div class="row header">
        ...
        <div class="col-md-12 p-0 header_img_container">
            <img src="/storage/page_images/contacts.jpg" class="img-responsive" alt="Contact us for Tanzania Safari">
        </div>
    </div>
                ...
                <form action="{{ action('PageController@booking') }}" method="POST">
                    ...
                    <label for="package">Safari Package of Choice</label>
                        @if(isset($booked_tour))
                            <input type="text" name="package" id="package" class="form-control input-lg" value="{{ $booked_tour->name }}" required>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success"><i class="fa fa-send mr-2"></i>Submit</button>
                        <button type="reset" class="btn btn-default"><i class="fa fa-times mr-2"></i>Clear</button>
                    </div>
                </form>
            </div>
            <div class="col-md-6">
                @if(isset($booked_tour))
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body p-0">
                            <img src="/storage/tour_images/{{ $booked_tour->photo }}" class="img-responsive" alt="{{ $booked_tour->name }}">
                        </div>
                        <div class="panel-footer">
                            <h3 class="ubuntucondensed"><i class="fa fa-check text-warning mr-3"></i>{{ $booked_tour->name }}</h3>
                            <hr>
                            <div class="text-justify assistant-light">{!! str_limit($booked_tour->meta_description, 250) !!}</div>
                            ...
                            {{--@else--}}
                                {{--<h3 class="assistant-light text-muted">Sorry, No fixed Pricing. Please enquire..!</h3>--}}
                            @endif
                        </div>
                    </div>
                @else
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-inline mt-4">
                                <li class="mr-2"><a href="https://www.tripadvisor.com/UserReviewEdit-g297913-d19432995-Take_Me_To_Tanzania_Adventure_Safaris-Arusha_Arusha_Region.html" target="_blank"><i class="fa fa-3x fa-tripadvisor"></i></a></li>
                                <li class="mr-2"><a href="https://web.facebook.com/TakemetoTanzania/" target="_blank"><i class="fa fa-3x fa-facebook-square"></i></a></li>
                                <li class="mr-2"><a href="https://Twitter.com/ToTanzania/" target="_blank"><i class="fa fa-3x fa-twitter"></i></a></li>
                                <li class="mr-2"><a href="https://www.instagram.com/take_me_to_tanzania/" target="_blank"><i class="fa fa-3x fa-instagram"></i></a></li>
                                <li class="mr-2"><a href="https://wa.me/+255764863068" target="_blank"><i class="fa fa-3x fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    </div>
                @endif
