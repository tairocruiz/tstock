...
<div class="text-uppercase">
    <h3 class="ubuntucondensed">Website Management Links</h3>
    <hr>
    <div class="row list-group assistant-light">
        ...
        <a href="/admin/destination-categories" class="list-group-item"><i class="fa fa-angle-right mr-2"></i>Destination Categories</a>
