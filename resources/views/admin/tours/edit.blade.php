        ...
        <div class="col-md-6">
            ...
            <form action="{{ action('TourController@update',$tour->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="seo_title" name="seo_title" class="form-control" maxlength="80" value="{{ $tour->seo_title }}">
                </div>
                <div class="form-group">
                    ...
                    <textarea name="meta_description" id="meta_description" class="form-control" cols="30" rows="2" maxlength="175">{{ $tour->meta_description }}</textarea>
                </div>
                <div class="row">
                    <div class="form-group col-md-2">
                        <label for="days">Edit Days</label>
                        <input type="number" id="days" name="days" class="form-control" value="{{ $tour->days }}" required>
                    </div>
                    <div class="form-group col-md-8">
                        <label for="best_time">Edit Best Time to visit with this Tour Package</label>
                        <input type="text" id="best_time" name="best_time" maxlength="30" class="form-control" value="{{ $tour->best_time }}">
                    </div>
                    <div class="form-group col-md-2">
                        <label for="price">Edit Price</label>
                        <input type="number" id="price" name="price" class="form-control" value="{{ $tour->price }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="description">Edit Day 2 Day Tour Description</label> <small class="description-character-counter pull-right"><span class="char-counter">0</span> characters total</small>
                    <textarea name="description" id="description" class="form-control textarea" cols="30" rows="10">{{ $tour->description }}</textarea>
                </div>
                <div class="form-group">
                    <label for="photo">Change Package Photo</label> <small class="text-muted pull-right">( 1400 by 500px )</small>
